...
namespace HPR
{
    public static class ThirdPartyAssetIntegrator
    {
        ...
        [MenuItem("Tools/HPR/Integrate/Apply Door Pack")]
        ...
        [MenuItem("Tools/HPR/Integrate/Apply Door Pack From Batch")]
        public static void ApplyDoorPackFromBatch()
        {
            ApplyDoorPack();
        }

        [MenuItem("Tools/HPR/Integrate/Apply Furniture Pack")]
        ...
        [MenuItem("Tools/HPR/Integrate/Apply Furniture Pack From Batch")]
        public static void ApplyFurniturePackFromBatch()
        {
            ApplyFurniturePack();
        }

        [MenuItem("Tools/HPR/Integrate/Apply Weapon Pack")]
        ...
        [MenuItem("Tools/HPR/Integrate/Apply Weapon Pack From Batch")]
        public static void ApplyWeaponPackFromBatch()
        {
            ApplyWeaponPack();
        }

        [MenuItem("Tools/HPR/Integrate/Apply House Pack")]
        ...
        [MenuItem("Tools/HPR/Integrate/Apply House Pack From Batch")]
        public static void ApplyHousePackFromBatch()
        {
            ApplyHousePack();
        }

        [MenuItem("Tools/HPR/Integrate/Apply Character Packs")]
        ...
        [MenuItem("Tools/HPR/Integrate/Apply Character Packs From Batch")]
        public static void ApplyCharacterPacksFromBatch()
        {
            ApplyCharacterPacks();
        }

        [MenuItem("Tools/HPR/Integrate/Apply Interior Packs From Batch")]
        ...
        [MenuItem("Tools/HPR/Integrate/Apply Selected Local Packs From Batch")]
