...
sudo -u hans -H env UNITY=/data/apps/Unity/Hub/Editor/6000.4.0f1/Editor/Unity PROJECT=/data/src/github/games/unity/projects/fps_demo LOG=/data/src/github/games/unity/assetstore/logs/catalog_furniture_pack.log bash -lc '"$UNITY" -batchmode -nographics -projectPath "$PROJECT" -executeMethod HPR.PrefabCatalogReporter.ReportPrefabCatalogFromArgs -assetFolder "Assets/Furniture Mega Pack" -quit -logFile "$LOG"'
sudo -u hans -H env UNITY=/data/apps/Unity/Hub/Editor/6000.4.0f1/Editor/Unity PROJECT=/data/src/github/games/unity/projects/fps_demo LOG=/data/src/github/games/unity/assetstore/logs/apply_furniture_pack.log bash -lc '"$UNITY" -batchmode -nographics -projectPath "$PROJECT" -executeMethod HPR.ThirdPartyAssetIntegrator.ApplyFurniturePackFromBatch -quit -logFile "$LOG"'
sudo -u hans -H env UNITY=/data/apps/Unity/Hub/Editor/6000.4.0f1/Editor/Unity PROJECT=/data/src/github/games/unity/projects/fps_demo LOG=/data/src/github/games/unity/assetstore/logs/build_after_furniture.log bash -lc '"$UNITY" -batchmode -nographics -projectPath "$PROJECT" -executeMethod HPR.SceneBootstrap.BuildLinux -quit -logFile "$LOG"'
