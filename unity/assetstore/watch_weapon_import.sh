...
sudo -u hans -H env UNITY=/data/apps/Unity/Hub/Editor/6000.4.0f1/Editor/Unity PROJECT=/data/src/github/games/unity/projects/fps_demo LOG=/data/src/github/games/unity/assetstore/logs/catalog_weapon_pack.log bash -lc '"$UNITY" -batchmode -nographics -projectPath "$PROJECT" -executeMethod HPR.PrefabCatalogReporter.ReportPrefabCatalogFromArgs -assetFolder "Assets/Low Poly Weapons VOL.1" -quit -logFile "$LOG"'
sudo -u hans -H env UNITY=/data/apps/Unity/Hub/Editor/6000.4.0f1/Editor/Unity PROJECT=/data/src/github/games/unity/projects/fps_demo LOG=/data/src/github/games/unity/assetstore/logs/apply_weapon_pack.log bash -lc '"$UNITY" -batchmode -nographics -projectPath "$PROJECT" -executeMethod HPR.ThirdPartyAssetIntegrator.ApplyWeaponPackFromBatch -quit -logFile "$LOG"'
