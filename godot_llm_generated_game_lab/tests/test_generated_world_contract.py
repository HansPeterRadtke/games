...
for token in ['res://data/generated_world.json','thor-sdxl-reviewed-identity-anchored-animation','GeneratedPlayerAnimation','GeneratedAnimation','sheet_resource','fallback_used','llmGameGodotMove','llmGameGodotAction']:
