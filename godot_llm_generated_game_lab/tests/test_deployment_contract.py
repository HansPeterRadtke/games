...
assert 'your-mom-temporal-absolute-paths-v3' in shell
...
assert 'your-mom-temporal-absolute-paths-v3' in build
assert 'your-mom-temporal-absolute-paths-v3' in install
